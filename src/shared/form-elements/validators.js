...
const VALIDATOR_TYPE_CLASSPASSCODE = "CLASSPASSCODE";
...
export const VALIDATOR_CLASSPASSCODE = (val) => ({
  type: VALIDATOR_TYPE_CLASSPASSCODE,
  val: val,
});
...
export const validate = (value, validators) => {
  ...
  for (const validator of validators) {
    ...
    if (validator.type === VALIDATOR_TYPE_CLASSPASSCODE) {
      isValid = isValid && value === "123456";
    }
